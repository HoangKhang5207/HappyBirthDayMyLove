const contentLetterSrart_actived = "CHÚC VỢ IUUU CỦA ANH SINH NHẬT VUI VẺ, VỢ HÃY MỞ BỨC THƯ NÀY III:>>." //Lời mở đầu cho bức thư
const mainContentLetter = "Gửi EM, chúc EM sinh nhật tràn đầy niềm vui và hạnh phúc, chúc EM ngày càng xinh đẹp, đáng yêu và dễ thương nữa nè và chúc EM ngày càng yêu anh nhiều hơn nhoa, có được EM anh luôn suy nghĩ như là anh có được kho báu quý giá nhất vậy, anh chỉ muốn cùng EM đi bên nhau thật lâu thật dài EM nhóaaa. YEU EM, HAPPY BIRTHDAY MY DARLING <3." //Nội dung của bức thư
